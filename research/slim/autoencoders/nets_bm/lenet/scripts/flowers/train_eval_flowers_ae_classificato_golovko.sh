#!/usr/bin/env bash
MODEL_FOLDER=flowers/golovko/lenet_sdc_1/cgrad_ep_10_batch_10_relu
...
AUTOENCODER_PATH=/media/w_programs/Development/Python/tf_autoencoders/checkpoints/${MODEL_FOLDER}/train_ae/
