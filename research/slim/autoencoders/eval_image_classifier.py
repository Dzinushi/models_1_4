...
def main(_):
    ...
    with tf.Graph().as_default():
        ...
        labels_placeholder = tf.placeholder(tf.int32, shape=(FLAGS.batch_size, ), name='label')
        ...
        if FLAGS.max_num_batches:
            ...
            num_batches = math.ceil(dataset.num_samples['valid'] / float(FLAGS.batch_size))
